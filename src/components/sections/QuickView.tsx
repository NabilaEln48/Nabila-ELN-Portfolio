...
export default function QuickView() {
  ...
  return (
    <section 
      ref={containerRef}
      id="quickview"
      /* MATCHED WITH SKILLS: py-20 (mobile) / py-32 (desktop) and rounded-t/b logic */
    ...
    >
      ...
      <div className="container relative z-20 mx-auto max-w-6xl">
        ...
        <div className="mb-12 md:mb-16 text-center md:text-left">
          <motion.span className="block text-cyan-400 text-[10px] md:text-[12px] uppercase font-bold mb-3 tracking-[0.8em]">Capabilities</motion.span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-min md:auto-rows-[250px]">
          ...
          >
              <div className="relative z-10">
                <span className="text-[10px] text-cyan-400 font-bold tracking-[0.3em] uppercase mb-4 block">Server Side</span>
                <h3 className="text-2xl md:text-5xl font-black uppercase leading-none mb-4">Scalable <br className="hidden md:block"/> Logic.</h3>
          ...
          >
            ...
            <p className="text-white/20 text-[8px] font-mono uppercase mt-6 tracking-widest">Automation & DevOps</p>
          </motion.div>

          {/* CARD 3: HYBRID FIGMA/DETAILS */}
          <motion.div 
          ...
          >
              <div className="relative z-10 md:w-1/2 mb-6 md:mb-0">
                <h3 className="text-2xl md:text-3xl font-black text-black uppercase tracking-tighter leading-tight mb-3">Figma to Reality</h3>
              ...
              <div className="relative z-10 md:w-1/2 grid grid-cols-2 gap-4 border-t md:border-t-0 md:border-l border-gray-100 pt-6 md:pt-0 md:pl-12">
                <div>
                  <p className="text-[9px] font-bold text-cyan-600 uppercase tracking-widest mb-1">Databases</p>
                  <h4 className="text-black font-black uppercase text-[10px]">PostgreSQL / Mongo / MySQL</h4>
                </div>
                <div>
                  <p className="text-[9px] font-bold text-purple-600 uppercase tracking-widest mb-1">Primary Stack</p>
                  <h4 className="text-black font-black uppercase text-[10px]">Python / JS / Tailwind</h4>
                </div>
              </div>
          </motion.div>
